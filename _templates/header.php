...
<html>
	<head>
		...
		<script>jQl.loadjQ('https://cdn.jsdelivr.net/combine/gh/jquery/jquery@3/dist/jquery.min.js,gh/LeaVerou/prefixfree@1/prefixfree.min.js,gh/jackmoore/autosize@4/dist/autosize.min.js,gh/eustasy/jQuery.equalize@1/jquery.equalize.min.js,gh/eustasy/jQuery.downBoy@1/jquery.downboy.min.js');</script>
		<script>$(function(){autosize($('textarea'));});</script>
		<script>$(function(){
				$('textarea').one('click',function(){$(this).select();});
				$('textarea').dblclick(function(){$(this).select();});
			})
		</script>
		<script>
			$(function(){
