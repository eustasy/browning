<?php
	...
	if ( is_readable(__DIR__.'/_settings/browning.custom.php') ) {
		...
		echo '<p>You need to copy <code class="background-midnight-blue color-white rounded display-inline">_settings/browning.default.php</code> to <code  class="background-midnight-blue color-white rounded display-inline">_settings/browning.custom.php</code> and edit it with keys for Mailgun and Recaptcha.</p>';
		echo '</div>';
		echo '<div class="smablet-quarter"></div>';
